...
import ru.stepev.test.training.at.hw5.model.component.MenuItem;
import ru.stepev.test.training.at.hw5.model.component.TextField;
import ru.stepev.test.training.at.hw5.model.component.TextLabel;
...
public class FluentHomePage implements BasePage {
    ...
    @FindBy(xpath = "//header//a[@href='user-table.html']")
    private Link linkUserTablePage;
    ...
    public void clickHeaderMenuService() {
        headerMenuService.click();
    }

    public DifferentElementsPage clickButtonDifferentElementsPage() {
    ...
    public UserTablePage clickUserTablePage() {
        linkUserTablePage.click();
